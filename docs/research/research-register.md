...
workflow_v1_persistence_checker_candidate_task_id: ADW-WF1-PERSISTENCE-CHECKER-DEVELOP-CORR-003
...
[ADW-WF1-PERSISTENCE-CHECKER-GATE-001](../design/ADW-WF1-PERSISTENCE-CHECKER-GATE-001.md) selects one manually invoked, deterministic, offline persistence checker as a narrow D3 exception for bounded development and synthetic producer tests. Its decision is `AUTHORIZE BOUNDED CHECKER DEVELOPMENT`; D3 otherwise remains deferred. A three-file checker implementation candidate now exists at [tools/persistence_checker.py](../../tools/persistence_checker.py), with focused synthetic tests at [tests/test_persistence_checker.py](../../tests/test_persistence_checker.py) and a usage note at [docs/tooling/persistence-checker.md](../tooling/persistence-checker.md). Candidate persistence establishes identity only. Independent review in [ADW-WF1-PERSISTENCE-CHECKER-REVIEW-001](../design/ADW-WF1-PERSISTENCE-CHECKER-REVIEW-001.md) found 0 BLOCKER, 3 MAJOR and 2 MINOR findings and returned `request-corrected-checker-candidate`; the reviewed candidate remains unaccepted and unauthorized for operational reliance.
